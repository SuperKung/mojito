...
class MojitoBuilder {
    ...
    inline fun mojitoListener(
        ...
        crossinline beforeFinish:(position: Int,view:MojitoView) -> Unit = {_,_->},
        ...
        override fun beforeFinish(pagePosition: Int, mojitoView: MojitoView) = beforeFinish(pagePosition, mojitoView)
